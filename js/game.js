 ...
 * x2048
 *
 * Version: 0.1 (17-MAR-2014)
 */

 //'analytics'
require(['KeyboardInputManager', 'HTMLActuator', 'LocalScoreManager', 'Grid', 'Tile', 'libs/requestAnimationFrame' ], function(InputManager, Actuator, ScoreManager, Grid, Tile) {
